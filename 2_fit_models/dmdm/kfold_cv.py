...
from data_io import load_glm_vectors, get_file_dir, load_glmhmm_data, scan_glmhmm_output, get_best_map_params
            ...
            for model_idx, K in enumerate(self.K_vals):
                ...
                for A_idx, alpha in enumerate(self.Alpha_vals):
                    for S_idx, sigma in enumerate(self.Sigma_vals):
                        ...
                        self.cvbt_folds_model[A_idx, S_idx, model_idx, fold] = cvbt_thismodel_thisfold
                        self.cvbt_train_folds_model[A_idx, S_idx, model_idx, fold] = train_cvbt_thismodel_thisfold
        ...
        for fold_tuning in tqdm(range(self.num_folds)):
            ...
            if len(test_inpt_y) > 0:
                ...
                if self.model == "GLM_HMM_y":
                 ...
                 # meaning there is no test data for this fold
                 self.cvbt_folds_model[:, :, :, this_fold_training] = None
                 self.cvbt_train_folds_model[:, :, :, this_fold_training] = None
